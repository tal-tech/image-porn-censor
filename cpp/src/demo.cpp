...
int main(int argc, char* argv[]) {
  const std::string model_repository = "/home/guoweiye/workspace/image-porn-censor/cpp/src/data/models/cls_image_porn_resnext50_v1.0.0";
  const std::string image_dir = "/home/guoweiye/workspace/image-porn-censor/cpp/src/images";
  int run_loop = 1;
  ...
  // 设置模型名称, 模型输入名, 模型输出名
  std::string model_name = "cls_image_porn_resnext50_pipeline";
